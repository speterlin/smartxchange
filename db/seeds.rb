...
u10 = User.create!(email: 'example10@gmail.com',password: 'password', name: 'The B', language: 'Italian', language_level: 2, title: "Dancer", birthdate: '2001-6-13', nationality: "Italian");
u11 = User.create!(email: 'example11@gmail.com',password: 'password', name: 'The M', language: 'German', language_level: 3, title: "Model", birthdate: '2004-6-13', nationality: "French"); # French-Italian
u12 = User.create!(email: 'example12@gmail.com',password: 'password', name: 'The W', language: 'Spanish', language_level: 4, title: "Model", birthdate: '1995-6-13', nationality: "Turkish");
u13 = User.create!(email: 'example13@gmail.com',password: 'password', name: 'The S', language: 'Danish', language_level: 4, title: "Model", birthdate: '1995-6-13', nationality: "Turkish");
