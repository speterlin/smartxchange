...
b1 = Board.create!(title: 'Spanish', description: 'A board for those looking to learn and practice Spanish. A board where you can post about potential meetups, tutoring offers, professional tips, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
...
b7 = Board.create!(title: 'Mandarin Chinese', description: 'A board for those looking to learn and practice Mandarin Chinese. A board where you can post about potential meetups, tutoring offers, professional tips, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');

p1 = Package.create!(classification: 'Standard', description: 'Access to the Platform', price: 0)
p2 = Package.create!(classification: 'Premium', description: 'Access to conversations with persons of interest (Professors, Managers, CEOs, artists, etc), language learning aids (chatbots, smartXchange verified tutors, tutor materials), language related jobs listed on our platform, and tailored services to meet your needs!', price: 4.99)
