...
b3 = Board.create!(title: 'English', description: 'A board for those looking to learn and practice English. A board where you can post about potential language exchange meetups, tutoring offers, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
b4 = Board.create!(title: 'Italian', description: 'A board for those looking to learn and practice Italian. A board where you can post about potential language exchange meetups, tutoring offers, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
b5 = Board.create!(title: 'German', description: 'A board for those looking to learn and practice German. A board where you can post about potential language exchange meetups, tutoring offers, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
b6 = Board.create!(title: 'French', description: 'A board for those looking to learn and practice French. A board where you can post about potential language exchange meetups, tutoring offers, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and educational, interesting, or other material. You can upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
