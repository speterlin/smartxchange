...
b1 = Board.create!(title: 'General Board', description: 'A board where you can post about potential language exchange meetups, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and potential jobs / work you have to offer. You can also upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
b2 = Board.create!(title: 'Smart Jobs Board', description: 'A board where you can post about potential language exchange meetups, your projects (such as Kickstarter projects), links to your work (such as art, design, development), and potential jobs / work you have to offer. You can also upvote or downvote a post (making someone\'s or your own post more popular), comment on a post, and follow a post so that you receive all notifications for that post. You are limited to 5 posts, 10 votes, and 10 comments per 24 hour period :).');
