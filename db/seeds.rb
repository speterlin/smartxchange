...
u12 = User.create!(email: 'example13@gmail.com',password: 'password', name: 'The SLNAMRGS', language: 'Spanish', language_level: 4, title: "Model at DD, Inc.", birthdate: '1995-6-13', nationality: "Turkish");
