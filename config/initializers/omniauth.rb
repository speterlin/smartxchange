Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :linkedin, ENV['LINKEDIN_API_KEY'], ENV['LINKEDIN_SECRET_KEY'], :fields => ['id', 'email-address', 'first-name', 'last-name', 'headline', 'location', 'industry', 'summary', 'specialties', 'positions', 'picture-urls::(original)', 'public-profile-url', 'picture-url', 'picture_url'] #, :scope => 'r_liteprofile'
end
