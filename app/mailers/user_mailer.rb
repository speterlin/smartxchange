class UserMailer < ApplicationMailer
  ...
  def set_footer_urls
    ...
    @url_tutors = "http://www.smartxchange.es/users/tutors"
    @url_premium_subscription = "http://www.smartxchange.es/about#premium"
  end

  def add_campaign_to_footer(campaign)
    @url_tutors = "http://www.smartxchange.es/users/tutors#{campaign}"
  ...
  def set_name_and_title_and_unsubscribe_and_header(user, title)
    ...
    @url_email_subscription = "http://www.smartxchange.es/users/#{@user.id}/settings/email_subscription?id=#{@unsubscribe_hash}"
